...
export const codeBlock = tv({
    slots: {
        container: "relative w-full text-sm rounded-2xl flex flex-col",
        header: "relative w-full flex items-center justify-between px-5 py-2.5",
        filename: "font-codeblock",
        pre: "relative w-full grow flex flex-nowrap flex-col py-5 overflow-auto",
        code: "contents font-codeblock",
    },
});
