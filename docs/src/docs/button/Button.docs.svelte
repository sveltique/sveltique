<script>
	...
	import { basicCode, colorCode, disabledCode, shapeCode, sizeCode } from './content';
</script>
...
<ul class="list-disc pl-5">
	...
	<li>
		<strong>danger</strong> : indicates destructive or irreversible actions, styled with red tones
	</li>
</ul>
